...
/// <summary>
/// The colour each kind of chat line is shown in, by its log text type. One
/// table for every reader: the chat window draws with it, and a session with
/// no window writes its console in the same colours.
/// </summary>
public static class RuntimeChatColors
{
    ...
    /// <summary>The colour for a log text type, or false for a type the table does not list.</summary>
